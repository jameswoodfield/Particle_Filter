...
class NS_SETD_KT_CM_JAX(BaseModel):
...
@jax.jit
def SETDRK4(u, kx, ky, mask, E, E_2, Q, f1, f2, f3, basis_1, basis_2, basis_3, dt, dW, dB, dZ):
    ...
    Nv = N(v,kx,ky,mask,rvf1_hat,rvf2_hat,rvf3_hat) #  N takes fourier -> physical space -> nonlinarity -> fourier
    a = E_2 * v + Q * Nv
...
NS_params_additive = {# Heat equation. 
    "equation_name": 'Navier Stokes',  
    "nx": int(128*4),        # Grid size
    "xmin": 0.0,     # Minimum x-coordinate
    "xmax": 1.0,     # Maximum x-coordinate
